...
const Skill = () => {
    return (
        <>
            <Background />
            <div id='skill' data-aos='fade-up' data-aos-delay='300'  className='absolute top-0 flex lg:flex-row lg:items-center lg:justify-center w-full px-4 lg:px-40 sm:pb-24 md:pt-16 sm:pt-24 md:pb-24 md:mt-16 mt-12 z-10'>
